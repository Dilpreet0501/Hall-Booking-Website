  ...
  return (
    <div className='form_class'>
      <form className="f1">
        ...
        <button type="submit"><Link to="/booking" ><div className='linkcol'>Click to open booking calendar</div></Link></button>
      ...
      <br></br>
       ...
       <br></br>
        <div className='heading' style={{textAlign:'left'}}>Email</div>
